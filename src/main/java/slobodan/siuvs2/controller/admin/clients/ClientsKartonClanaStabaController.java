...
public class ClientsKartonClanaStabaController {
    ...
    @GetMapping(value = "/admin/clients/{clientId}/kartonClanaStaba/{kartonId}")
    ...
    public String adminkartonClanovaStabaNewSave(
            @PathVariable final ClientId clientId,
...
//        KartonUdruzenja karton = new KartonUdruzenja();
        ...
        if (action.equals("save")) {
            ...
            return "redirect:/admin/clients/" + clientId + "/kartonClanaStaba/" + karton.getId() + "/dodajClana";
        }
    ...
    @GetMapping(value = "/admin/clients/{clientId}/kartonClanaStaba/{kartonId}/izmeniKarton")
    public String adminkartonClanaStabaEdit(
            @PathVariable final ClientId clientId,
            @PathVariable final KartonClanovaStabaId kartonId,
            final RedirectAttributes redirectAttributes,
            final Model model
    ...
    @PostMapping(value = "/admin/clients/{clientId}/kartonClanaStaba/{kartonId}/izmeniKarton")
    public String adminkartonClanaStabaEditSave(
            @PathVariable final ClientId clientId,
                        @PathVariable final KartonClanovaStabaId kartonId,
            @RequestParam(value = "action", required = true) String action,
            @RequestParam(value = "adresa_staba", defaultValue = "/") String adresa_staba,
