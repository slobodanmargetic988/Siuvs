...
@Repository("podvrstaMTSRepository")
public interface PodvrstaMTSRepository extends JpaRepository<PodvrstaMTS, Integer> {



    List<PodvrstaMTS> findAllBy();
    
  PodvrstaMTS findOne(Integer podvrstaMTSId);
